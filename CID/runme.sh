...
python3 cid_pecan.py --data_dir $dir$dem$crater_detections_dir --write_dir $dir$dem$write_dir --gt_data_dir $dir$dem$gt_crater_detections_dir --crater_catalogue_file $dir$crater_catalogue --calibration_file $dir$dem$calibration_file --flight_file $dir$dem$flight_file --lower_matched_percentage $lower_matched_percentage --upper_matched_percentage $upper_matched_percentage --write_position_dir $dir$dem$write_position_dir --attitude_noise_deg $attitude_noise_deg
